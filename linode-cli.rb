...
class LinodeCli < Formula
  ...
  sha256 'de9ef4796028bde11776378a0ec4b50e96dd269ea2ba161a1fcdb9fb9b839b30'
  ...
  resource 'Scalar::List::Utils' do
    url 'http://www.cpan.org/authors/id/P/PE/PEVANS/Scalar-List-Utils-1.47.tar.gz'
  ...
  resource 'Test::Simple' do
    url 'http://www.cpan.org/authors/id/E/EX/EXODIST/Test-Simple-1.302106.tar.gz'
